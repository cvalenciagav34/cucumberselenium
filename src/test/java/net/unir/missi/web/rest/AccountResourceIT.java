...
import java.util.*;
import net.unir.missi.IntegrationTest;
import net.unir.missi.config.Constants;
import net.unir.missi.domain.User;
import net.unir.missi.repository.AuthorityRepository;
...
import net.unir.missi.service.dto.PasswordChangeDTO;
import net.unir.missi.web.rest.vm.KeyAndPasswordVM;
import net.unir.missi.web.rest.vm.ManagedUserVM;
